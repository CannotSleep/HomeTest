 ...
 */
public class SevenFood2 extends Base {
    TextView tv1;
    TextView tv2;
    @Override
    public int setView() {
        return R.layout.seven_food_make2;
    }

    @Override
    public void initView() {
        tv1= (TextView) findViewById(R.id.seven_food_b_a_tv);
        tv2= (TextView) findViewById(R.id.seven_food_b_b_tv);
        initList();
        initList1();
    }
    ...
    public void sevenb(View view){
        Intent intent = new Intent(SevenFood2.this, Noon.class);
        intent.putExtra("a","7");
