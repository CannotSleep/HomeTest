...
public class SixFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.six_fragment,container,false);
        tv= (TextView) rootView.findViewById(R.id.six_tv);
        btn= (Button) rootView.findViewById(R.id.six_btn);
