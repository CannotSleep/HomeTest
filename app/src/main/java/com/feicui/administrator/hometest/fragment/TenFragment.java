...
public class TenFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.ten_fragment,container,false);
        tv= (TextView) rootView.findViewById(R.id.ten_tv);
        btn= (Button) rootView.findViewById(R.id.ten_btn);
