...
public class EightFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.eight_fragment,container,false);
        tv= (TextView) rootView.findViewById(R.id.eight_tv);
        btn= (Button) rootView.findViewById(R.id.eight_btn);
