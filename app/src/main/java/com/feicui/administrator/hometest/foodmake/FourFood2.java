 ...
 */
public class FourFood2 extends Base {
    TextView tv;
    @Override
    public int setView() {
        return R.layout.four_food_make2;
    }

    @Override
    public void initView() {
        tv= (TextView) findViewById(R.id.four_food_make2_tv);
        initList();
    }
    ...
    public void fourb(View view){
        Intent intent =new Intent(FourFood2.this, Noon.class);
        intent.putExtra("a","4");
