...
public class NineFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.nine_fragment,container,false);
        tv= (TextView) rootView.findViewById(R.id.nine_tv);
        btn= (Button) rootView.findViewById(R.id.nine_btn);
