 ...
 */
public class EightFood2 extends Base {
    TextView tv1;
    TextView tv2;
    @Override
    public int setView() {
        return R.layout.eight_food_make2;
    }

    @Override
    public void initView() {
        tv1= (TextView) findViewById(R.id.eight_food_b_a_tv);
        tv2= (TextView) findViewById(R.id.eight_food_b_b_tv);
        initList();
        initList1();
    }
    ...
    public void eightb(View view){
        Intent intent = new Intent(EightFood2.this, Noon.class);
        intent.putExtra("a","8");
